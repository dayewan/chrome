  ...
  switch (host) {
    ...
    case "www.hibobi.com":
      ...
      if (pathname.match("/detail/")) {
        ...
        const goodTitle = $(".detail-title")[0].textContent.trim();
        const titleLink = goodTitle.replace(/ /g, "-");
        title = href.replace(/detail\/.*?\?/, "detail/" + titleLink + "?");
        let image = $(".mint-swipe img");
        image.each(function(item) {
